...
function iniciarJuegoClics() {
  ...
  // Creamos el contenido inicial
  contenedorMinijuego.innerHTML = `
    <div id="juegoClicRapido" style="
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
  ...
  ">
    ...
    <p style="
      ...
      color: #7efc7e;
      font-weight: bold;
    ">Ganaste ${Math.ceil(clics / 2)} monedas 🎉</p>
...
sacoDeBoxeo.addEventListener("click", () => {
 cantidadGolpes++;
  cantidadGolpesElem.innerHTML = "x" + cantidadGolpes;

  // Añadir clase de golpe
